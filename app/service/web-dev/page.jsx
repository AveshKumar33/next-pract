            ...
            <div className="max-w-4xl w-full space-y-8">
                ...
                <div className="space-y-6 pt-8">
                    <div className="p-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 space-y-4">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Our Expertise</h2>
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            We specialize in building custom web applications using cutting-edge technologies
                            like React, Next.js, Node.js, and more. Our team follows best practices to ensure
                            your application is fast, secure, and maintainable.
                        </p>
                    </div>

                    <div className="p-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 space-y-4">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Technologies</h2>
                        <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">⚛️</span>
                                <span>React & Next.js for modern frontend development</span>
                            </li>
                            <li className="flex items-start gap-3">
                            ...
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">🗄️</span>
                                <span>PostgreSQL, MongoDB, and other database solutions</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">☁️</span>
                                <span>AWS, Vercel, and cloud deployment platforms</span>
                            </li>
                        </ul>
                    </div>
                </div>
