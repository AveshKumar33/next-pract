                ...
                <div className="space-y-6 pt-8">
                    <div className="p-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 space-y-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                            We provide strategic technical consulting to help businesses make informed decisions 
                            about their technology stack, architecture, and digital transformation. Our experts 
                            bring years of experience across various industries.
                        </p>
                    </div>

                    <div className="p-8 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 space-y-4">
                        <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Consulting Areas</h2>
                        <ul className="space-y-3 text-gray-600 dark:text-gray-400">
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">🏗️</span>
                                <span>System architecture design and review</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">📊</span>
                                <span>Technology stack selection and optimization</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-blue-500 mt-1">🔄</span>
